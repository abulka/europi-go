...
// go run ./cmd-demos/schedulerc-demo
// tinygo flash -target=pico --monitor ./cmd/cmd-demos/schedulerc-demo
...
func main() {
	...
	// Main Loop with blocking timer pattern
